...
import com.example.emergencyl.models.brokenlimbs
...
class BrokenlimbViewModel(var navController:NavHostController, var context: Context) {
    ...
    fun uploadInstruction(instruction:String,filePath:Uri){
        ...
        val storageRef = FirebaseStorage.getInstance().getReference()
            .child("brokenlimbss/$InstructionId")
        progress.show()
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var broken = brokenlimbs(instruction,instruction1, instruction2,imageUrl,InstructionId)
