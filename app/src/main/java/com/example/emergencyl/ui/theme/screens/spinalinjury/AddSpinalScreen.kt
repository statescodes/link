package com.example.emergencyl.ui.theme.screens.spinalinjury
...
fun AddChestpainScreenPreview(){
    ...
    com.example.emergencyl.ui.theme.screens.spinalinjury.AddSpinalScreen(navController = rememberNavController())
}